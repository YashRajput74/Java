...
class Google
{
	...
	{
		//When the JVM loads the class, memory is allocated for: Static variables, Method code and Class metadata
		Google e1= new Google();//new kisi bhi class ko memory deta hai...aur apne left side wale ko memory deta hai;
		//When an object is created using the new keyword, memory is allocated for: Non-Static data members, object-specific data.
